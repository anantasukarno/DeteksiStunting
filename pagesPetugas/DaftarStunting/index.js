...
export class DaftarStunting extends Component {
    constructor(props){
        super(props);
        this.state = {
            data: [],
    ...
    getData() {
        ...
        onValue(refAnggota, (snapshot) => {
            ...
            const filtered = asArray.filter((item) => {
                return item[1].alamat.kelurahan.toLowerCase().includes(this.state.wilayah.toLowerCase())
            });
    ...
    render() {
        ...
        <View style={styles.container}>
            ...
            <Text style={styles.paragraf}>Data Anak Desa {this.state.kelurahan}</Text>
            <FlatList
