...
import { faInfo, faUser, faUsers, faUserPlus, faUserCheck, faUserEdit, faUserGear, faUserTie, faLightbulb, faQuestionCircle, faCalculator, faSignOut} from '@fortawesome/free-solid-svg-icons'
...
export class Home extends Component {
    ...
    async componentDidMount(){
        ...
        await get(child(dbRef, `dataPetugas/${userId}`)).then((snapshot) => {
        if (snapshot.exists()) {
            this.setState({
    ...
    //   get(child(dbRef, `dataWilayah/${idKecamatan}/desa/${wilayah}`)).then((snapshot) => {
        ...
        <View style={styles.container}>
            <View style={styles.header}>
                <View>
                    ...
                    <Text style={styles.headerText2}>Wilayah tugas anda adalah Kelurahan {this.state.kelurahan}</Text>
                </View>
            ...
            <View style={styles.body}>
                    <View style={styles.bodyWrapperButton}>
                        <TouchableOpacity style={styles.bodyButton} onPress={()=> this.props.navigation.navigate('KenaliStunting')}>
            ...
            <View style={styles.body}>
                    <View style={styles.bodyWrapperButton}>
                        <TouchableOpacity style={styles.bodyButton} onPress={()=> this.props.navigation.navigate('DaftarAnggota')}>
                        <FontAwesomeIcon icon={ faUsers } style={styles.bodyIcon} size={25}/>
                            <Text style={styles.bodyText}>Daftar Anggota</Text>
                        </TouchableOpacity>
                    </View>
                    <View style={styles.bodyWrapperButton}>
                        <TouchableOpacity style={styles.bodyButton} onPress={()=> this.props.navigation.navigate('TambahAnggota')}>
                        <FontAwesomeIcon icon={ faUserPlus } style={styles.bodyIcon}  size={25}/>
                            <Text style={styles.bodyText}>Tambah Anggota</Text>
                        </TouchableOpacity>
                    </View>
                    
                    <View style={styles.bodyWrapperButton}>
                        
                        <TouchableOpacity style={styles.bodyButton} onPress={() => this.props.navigation.navigate('PermohonanAnggota')}>
                        <FontAwesomeIcon icon={ faUserCheck } style={styles.bodyIcon}  size={25}/>
                            <Text style={styles.bodyText}>Permohonan Anggota</Text> 
                        </TouchableOpacity>
                        {this.state.jumlahPermohonan > 0 &&
                                <View style={styles.notif}>
                                    <Text>{this.state.jumlahPermohonan}</Text>
                                </View>
                        }
            ...
            <View style={styles.body}>
            <View style={styles.bodyWrapperButton}>
                        <TouchableOpacity style={styles.bodyButton} onPress={()=> this.props.navigation.navigate('TambahPertumbuhan')}>
                        <FontAwesomeIcon icon={ faUserEdit } style={styles.bodyIcon}  size={25}/>
                            <Text style={styles.bodyText}>Update Data Pertumbuhan</Text>
                        </TouchableOpacity>
                    </View>
                    <View style={styles.bodyWrapperButton}>
                        <TouchableOpacity style={styles.bodyButton} onPress={()=> this.props.navigation.navigate('DaftarPetugas')}>
                        <FontAwesomeIcon icon={ faUserTie } style={styles.bodyIcon}  size={25}/>
                            <Text style={styles.bodyText}>Daftar Petugas</Text>
                        </TouchableOpacity>
                    </View>
