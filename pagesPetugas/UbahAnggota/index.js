...
export class UbahAnggota extends Component {
  constructor(props){
    super(props);
    this.state = {
      idUser: '',
  ...
  async getData(){
    ...
    get(child(dbRef, `dataAnggota/${idAnggota}`)).then((snapshot) => {
  ...
  onChangeTanggal = (event, selectedDate) => {
    ...
    async onSubmit(){
      if (!this.state.email || !this.state.nama || !this.state.nik || !this.state.tempatLahir || !this.state.tanggalLahir || !this.state.jenisKelamin || !this.state.kelurahan || !this.state.kecamatan ) {
        ...
        if(this.state.pertumbuhan == undefined){
          var postData = {
            ...
            level: 'anggota',
            status: 'disetujui',
            idAnggota: this.state.idAnggota,
          ...
          var postData = {
            ...
            jenisKelamin: this.state.jenisKelamin,
            foto: this.state.urlFoto,
            pertumbuhan: this.state.pertumbuhan,
            alamat: {
              distrik: this.state.kecamatan,
              kampung: this.state.kelurahan,
            },
        ...
        const updates = {};
        updates['/dataAnggota/' + this.state.idAnggota] = postData;
  ...
  render() {
    return (
      ...
      <Text style={styles.judul}>Tambah Anggota</Text>
        ...
        <Text style={styles.label}>Kampung</Text>
