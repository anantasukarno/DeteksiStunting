...
export class TambahPetugasAdmin extends Component {
  constructor(props){
    super(props);
    this.state = {
      idUser: '',
            ...
            if (this.state.isEmail) {
              ...
              onValue(refAnggota, async (snapshot) => {
                  ...
                  if (this.state.foto == 'https://firebasestorage.googleapis.com/v0/b/stunt-5913f.appspot.com/o/fotoAnggota%2Fuser.png?alt=media&token=b162b3d4-3e41-4895-8922-6577ed6b4b9c') {
                    ...
                    const fotoAnggota = sRef(storage, "fotoPetugas/"+ this.state.nik + ".jpg")
                    ...
                    await set(ref(db, 'dataPetugas/' + idUser), {
                      id: idUser,
                    ...
                    this.props.navigation.navigate('DaftarPetugasAdmin')
                  }
                }, {
                  onlyOnce: true
              });
  ...
  render() {
    ...
    return (
      ...
      <View style={styles.container} >
        <Text style={styles.text1}>Tambah Petugas</Text>
...
export default TambahPetugasAdmin