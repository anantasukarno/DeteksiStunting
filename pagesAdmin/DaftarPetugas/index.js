...
export class DaftarPetugasAdmin extends Component {
    constructor(props){
        super(props);
        this.state = {
            data: [],
    ...
    async componentDidMount(){
        ...
        const kecamatan = await AsyncStorage.getItem('kecamatan')
        this.setState({
            kelurahan: kelurahan,
            kecamatan: kecamatan,
        })
    ...
    getData() {
        ...
        const refAnggota = query(ref(db, "dataPetugas"))
    ...
    render() {
        ...
        <View style={styles.container}>
            <View style={styles.header}>
                ...
                <Text style={styles.judul}>Daftar Petugas</Text>
            </View>
            <View>
                ...
                renderItem = {({item}) => {
                    return(
                        ...
                        <View style={styles.itemBox}>
                            ...
                            <TouchableOpacity style={styles.aksi} onPress={() => this.props.navigation.navigate('DetailPetugasAdmin', {
                                idPetugas: this.state.data[item].id
                            })}>
            ...
            />
            <TouchableOpacity style={styles.tombolTambah} onPress={() => this.props.navigation.navigate('TambahPetugasAdmin')}>
...
export default DaftarPetugasAdmin