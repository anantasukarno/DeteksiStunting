...
export class DaftarAdmin extends Component {
    constructor(props){
        super(props);
        this.state = {
            data: [],
    ...
    getData() {
        ...
        const refAnggota = query(ref(db, "dataAdmin"))
    ...
    render() {
        ...
        <View style={styles.container}>
            <View style={styles.header}>
                ...
                <Text style={styles.judul}>Daftar Admin</Text>
            </View>
            <View>
                ...
                renderItem = {({item}) => {
                    return(
                        ...
                        <View style={styles.itemBox}>
                            ...
                            <TouchableOpacity style={styles.aksi} onPress={() => this.props.navigation.navigate('DetailAdmin', {
                                idAdmin: this.state.data[item].id
                            })}>
            ...
            />
            <TouchableOpacity style={styles.tombolTambah} onPress={() => this.props.navigation.navigate('TambahAdmin')}>
